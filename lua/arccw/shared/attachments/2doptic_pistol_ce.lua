att.PrintName = "Pistol Scope"
att.Icon = Material("entities/tfa_hce_snow_objectiveflag.png")
att.Description = "A smart-linked 2x scope for the M6D Magnum"
...
local ScopeTexture	= Material("snowysnowtime/scopes/magnum_scope")
local proscopesize		= 700
