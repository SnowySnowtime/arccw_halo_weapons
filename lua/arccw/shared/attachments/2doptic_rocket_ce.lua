att.PrintName = "Rocket Scope"
att.Icon = Material("entities/tfa_hce_snow_objectiveflag.png")
att.Description = "A smart-linked 2x scope for the M41 Rocket Launcher"
...
local ScopeTexture	= Material("hud/scopes/ce_rocket_scope")
local proscopesize		= 255
...
att.Hook_DrawHUD = function(wep)
	...
	-- Draw surrounding
	surface.SetDrawColor(0, 0, 0, 108)
	// Left
