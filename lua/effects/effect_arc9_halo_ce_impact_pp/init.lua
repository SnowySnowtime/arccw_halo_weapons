...
function EFFECT:Init( data )
	...
	for i = 1,7 do
		...
		if (particle) then
			...
			particle:SetColor(math.Rand(80,90), math.Rand(220,255), math.Rand(100,120))
	...
	for i = 1,24 do
		...
		if (particle2) then
			...
			particle2:SetColor(math.Rand(80,100), math.Rand(220,255), math.Rand(100,130))
	...
	for i = 1,5 do
		...
		if (particle3) then
			...
			particle3:SetColor(math.Rand(80,100), math.Rand(220,255), math.Rand(100,130))
...
function EFFECT:Render()
	...
	local rgb = 255 * frac;
	local a = 255 * frac;
	local color = Color( math.Rand(200,250), math.Rand(220,255), math.Rand(125,155), a );
