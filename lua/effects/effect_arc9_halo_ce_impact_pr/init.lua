...
function EFFECT:Init( data )
	...
	if( emitter ) then
		...
		for i = 1, 1 do
			...
			local particle = emitter:Add( "effects/arc9ce/halo3/flash_large", self.Position + self.Normal * 2 );
		...
		for i = 1, 1 do
			...
			local particle = emitter:Add( "effects/arc9ce/halo3/explosive_burst", self.Position + self.Normal * 2 );
			particle:SetVelocity( ( self.Normal + Vector(math.Rand(3, 5),math.Rand(3, 5),1) * 0.75 ):GetNormal() * math.Rand( 75, 125 ) );
