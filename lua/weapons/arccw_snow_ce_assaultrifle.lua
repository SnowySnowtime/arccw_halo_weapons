...
SWEP.Attachments = {
    ...
    },
    {
        ...
        Offset = {
            vpos = Vector(5, -0.6, 5.25), -- offset that the attachment will be relative to the bone
            vang = Angle(0, 0, 10),
            wpos = Vector(8, 1.7, -6.5),
            wang = Angle(0, 0, 180)
        },
    },
	{
        PrintName = "Skin",
        Slot = {"skin_arce","skin_halouniversal"},
